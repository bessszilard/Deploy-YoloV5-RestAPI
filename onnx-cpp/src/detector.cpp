                           ...
                           const cv::Size &inputSize = cv::Size(640, 640))
{
    ...
    static Ort::AllocatedStringPtr inputNameUPtr = session.GetInputNameAllocated(0, allocator);
    const char *inputName = inputNameUPtr.get();
    static Ort::AllocatedStringPtr outputNameUPtr = session.GetOutputNameAllocated(0, allocator);
    const char *outputName = outputNameUPtr.get();

    // inputNames.push_back(session.GetInputName(0, allocator));
    // outputNames.push_back(session.GetOutputName(0, allocator));
    inputNames.push_back(inputNameUPtr.get());
    outputNames.push_back(outputNameUPtr.get()); //.GetOutputName(0, allocator));
